...
config.EDGE_PUSHER_ENABLED = true;
config.EDGE_PUSHER_EMPTY_DELAY = 30000;
config.BEDGE_PUSHER_BATCH_SIZE = 50;
config.EDGE_PUSHER_BATCH_DELAY = 500;
config.EDGE_PUSHER_ERROR_DELAY = 3000;
