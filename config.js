...
// WOOP DEBUG VALUES: DO NOT COMMIT WOOOOOOP
config.STATISTICS_COLLECTOR_INTERVAL = 10 * 1000; // 10 seconds
config.STATISTICS_COLLECTOR_EXPIRATION = 60 * 1000; // 1 minute
