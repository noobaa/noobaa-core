...
* <u>Type</u>: Number  
* <u>Default</u>: 4  
* <u>Description</u>: Set UV_THREADPOOL_SIZE in order to increase the performance of NooBaa - https://docs.libuv.org/en/v1.x/threadpool.html.  
* <u>Steps</u>:  
    ```
    1. Open /path/to/config_dir/config.json file.
    2. Set the config key -
...
* <u>Type</u>: Number  
* <u>Default</u>: 32MB = 33554432 bytes = 32 * 1024 * 1024  
* <u>Description</u>: Set Buffer pool memory limit in order to increase performance. Suggested values 1-4GB, service restart required.  
* <u>Steps</u>:  
    ```
    1. Open /path/to/config_dir/config.json file.
...
* <u>Type</u>: Boolean  
* <u>Default</u>: false  
* <u>Description</u>: This flag will disable configuration/account/bucket schema checks.   
