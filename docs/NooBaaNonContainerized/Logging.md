...
NooBaa service logs are written directly to stderr and to syslog (will be deprecated in the future).
...
- Logrotate is triggered when file size reaches 105MB limit. 
