...
| noobaa_nsfs_op_lstat_min_time_milisec                | Minimum time to lstat a path                        | milliseconds  |
| noobaa_nsfs_op_lstat_max_time_milisec                | Maximum time to lstat a path                        | milliseconds  |
| noobaa_nsfs_op_lstat_avg_time_milisec                | Average time to lstat a path                        | milliseconds  |
| noobaa_nsfs_op_lstat_count                           | Number of lstat operations                          | operations    |
| noobaa_nsfs_op_lstat_error_count                     | Number of errors in lstat operations                | errors        |
| noobaa_nsfs_op_statfs_min_time_milisec               | Minimum time to get filesystem statistics           | milliseconds  |
| noobaa_nsfs_op_statfs_max_time_milisec               | Maximum time to get filesystem statistics           | milliseconds  |
| noobaa_nsfs_op_statfs_avg_time_milisec               | Average time to get filesystem statistics           | milliseconds  |
| noobaa_nsfs_op_statfs_count                          | Number of statfs operations                         | operations    |
| noobaa_nsfs_op_statfs_error_count                    | Number of errors in statfs operations               | errors        |
| noobaa_nsfs_op_checkaccess_min_time_milisec          | Minimum time to check path access                   | milliseconds  |
| noobaa_nsfs_op_checkaccess_max_time_milisec          | Maximum time to check path access                   | milliseconds  |
| noobaa_nsfs_op_checkaccess_avg_time_milisec          | Average time to check path access                   | milliseconds  |
| noobaa_nsfs_op_checkaccess_count                     | Number of checkaccess operations                    | operations    |
| noobaa_nsfs_op_checkaccess_error_count               | Number of errors in checkaccess operations          | errors        |
| noobaa_nsfs_op_unlink_min_time_milisec               | Minimum time to unlink a file                       | milliseconds  |
| noobaa_nsfs_op_unlink_max_time_milisec               | Maximum time to unlink a file                       | milliseconds  |
| noobaa_nsfs_op_unlink_avg_time_milisec               | Average time to unlink a file                       | milliseconds  |
| noobaa_nsfs_op_unlink_count                          | Number of unlink operations                         | operations    |
| noobaa_nsfs_op_unlink_error_count                    | Number of errors in unlink operations               | errors        |
| noobaa_nsfs_op_unlinkat_min_time_milisec             | Minimum time to unlinkat a file                     | milliseconds  |
| noobaa_nsfs_op_unlinkat_max_time_milisec             | Maximum time to unlinkat a file                     | milliseconds  |
| noobaa_nsfs_op_unlinkat_avg_time_milisec             | Average time to unlinkat a file                     | milliseconds  |
| noobaa_nsfs_op_unlinkat_count                        | Number of unlinkat operations                       | operations    |
| noobaa_nsfs_op_unlinkat_error_count                  | Number of errors in unlinkat operations             | errors        |
| noobaa_nsfs_op_link_min_time_milisec                 | Minimum time to create a hard link                  | milliseconds  |
| noobaa_nsfs_op_link_max_time_milisec                 | Maximum time to create a hard link                  | milliseconds  |
| noobaa_nsfs_op_link_avg_time_milisec                 | Average time to create a hard link                  | milliseconds  |
| noobaa_nsfs_op_link_count                            | Number of link operations                           | operations    |
| noobaa_nsfs_op_link_error_count                      | Number of errors in link operations                 | errors        |
| noobaa_nsfs_op_linkat_min_time_milisec               | Minimum time to create a hard link with linkat      | milliseconds  |
| noobaa_nsfs_op_linkat_max_time_milisec               | Maximum time to create a hard link with linkat      | milliseconds  |
| noobaa_nsfs_op_linkat_avg_time_milisec               | Average time to create a hard link with linkat      | milliseconds  |
| noobaa_nsfs_op_linkat_count                          | Number of linkat operations                         | operations    |
| noobaa_nsfs_op_linkat_error_count                    | Number of errors in linkat operations               | errors        |
| noobaa_nsfs_op_mkdir_min_time_milisec                | Minimum time to create a directory                  | milliseconds  |
| noobaa_nsfs_op_mkdir_max_time_milisec                | Maximum time to create a directory                  | milliseconds  |
| noobaa_nsfs_op_mkdir_avg_time_milisec                | Average time to create a directory                  | milliseconds  |
| noobaa_nsfs_op_mkdir_count                           | Number of mkdir operations                          | operations    |
| noobaa_nsfs_op_mkdir_error_count                     | Number of errors in mkdir operations                | errors        |
| noobaa_nsfs_op_rmdir_min_time_milisec                | Minimum time to remove a directory                  | milliseconds  |
| noobaa_nsfs_op_rmdir_max_time_milisec                | Maximum time to remove a directory                  | milliseconds  |
| noobaa_nsfs_op_rmdir_avg_time_milisec                | Average time to remove a directory                  | milliseconds  |
| noobaa_nsfs_op_rmdir_count                           | Number of rmdir operations                          | operations    |
| noobaa_nsfs_op_rmdir_error_count                     | Number of errors in rmdir operations                | errors        |
| noobaa_nsfs_op_rename_min_time_milisec               | Minimum time to rename a file or directory          | milliseconds  |
| noobaa_nsfs_op_rename_max_time_milisec               | Maximum time to rename a file or directory          | milliseconds  |
| noobaa_nsfs_op_rename_avg_time_milisec               | Average time to rename a file or directory          | milliseconds  |
| noobaa_nsfs_op_rename_count                          | Number of rename operations                         | operations    |
| noobaa_nsfs_op_rename_error_count                    | Number of errors in rename operations               | errors        |
| noobaa_nsfs_op_writefile_min_time_milisec            | Minimum time to write a file                        | milliseconds  |
| noobaa_nsfs_op_writefile_max_time_milisec            | Maximum time to write a file                        | milliseconds  |
| noobaa_nsfs_op_writefile_avg_time_milisec            | Average time to write a file                        | milliseconds  |
| noobaa_nsfs_op_writefile_count                       | Number of writefile operations                      | operations    |
| noobaa_nsfs_op_writefile_error_count                 | Number of errors in writefile operations            | errors        |
| noobaa_nsfs_op_readfile_min_time_milisec             | Minimum time to read a file                         | milliseconds  |
| noobaa_nsfs_op_readfile_max_time_milisec             | Maximum time to read a file                         | milliseconds  |
| noobaa_nsfs_op_readfile_avg_time_milisec             | Average time to read a file                         | milliseconds  |
| noobaa_nsfs_op_readfile_count                        | Number of readfile operations                       | operations    |
| noobaa_nsfs_op_readfile_error_count                  | Number of errors in readfile operations             | errors        |
| noobaa_nsfs_op_readdir_min_time_milisec              | Minimum time to read a directory                    | milliseconds  |
| noobaa_nsfs_op_readdir_max_time_milisec              | Maximum time to read a directory                    | milliseconds  |
| noobaa_nsfs_op_readdir_avg_time_milisec              | Average time to read a directory                    | milliseconds  |
| noobaa_nsfs_op_readdir_count                         | Number of readdir operations                        | operations    |
| noobaa_nsfs_op_readdir_error_count                   | Number of errors in readdir operations              | errors        |
| noobaa_nsfs_op_fsync_min_time_milisec                | Minimum time to fsync a path                        | milliseconds  |
| noobaa_nsfs_op_fsync_max_time_milisec                | Maximum time to fsync a path                        | milliseconds  |
| noobaa_nsfs_op_fsync_avg_time_milisec                | Average time to fsync a path                        | milliseconds  |
| noobaa_nsfs_op_fsync_count                           | Number of fsync operations                          | operations    |
| noobaa_nsfs_op_fsync_error_count                     | Number of errors in fsync operations                | errors        |
| noobaa_nsfs_op_fileopen_min_time_milisec             | Minimum time to open a file                         | milliseconds  |
| noobaa_nsfs_op_fileopen_max_time_milisec             | Maximum time to open a file                         | milliseconds  |
| noobaa_nsfs_op_fileopen_avg_time_milisec             | Average time to open a file                         | milliseconds  |
| noobaa_nsfs_op_fileopen_count                        | Number of fileopen operations                       | operations    |
| noobaa_nsfs_op_fileopen_error_count                  | Number of errors in fileopen operations             | errors        |
| noobaa_nsfs_op_fileclose_min_time_milisec            | Minimum time to close a file                        | milliseconds  |
| noobaa_nsfs_op_fileclose_max_time_milisec            | Maximum time to close a file                        | milliseconds  |
| noobaa_nsfs_op_fileclose_avg_time_milisec            | Average time to close a file                        | milliseconds  |
| noobaa_nsfs_op_fileclose_count                       | Number of fileclose operations                      | operations    |
| noobaa_nsfs_op_fileclose_error_count                 | Number of errors in fileclose operations            | errors        |
| noobaa_nsfs_op_fileread_min_time_milisec             | Minimum time to read from an open file              | milliseconds  |
| noobaa_nsfs_op_fileread_max_time_milisec             | Maximum time to read from an open file              | milliseconds  |
| noobaa_nsfs_op_fileread_avg_time_milisec             | Average time to read from an open file              | milliseconds  |
| noobaa_nsfs_op_fileread_count                        | Number of fileread operations                       | operations    |
| noobaa_nsfs_op_fileread_error_count                  | Number of errors in fileread operations             | errors        |
| noobaa_nsfs_op_filewrite_min_time_milisec            | Minimum time to write to an open file               | milliseconds  |
| noobaa_nsfs_op_filewrite_max_time_milisec            | Maximum time to write to an open file               | milliseconds  |
| noobaa_nsfs_op_filewrite_avg_time_milisec            | Average time to write to an open file               | milliseconds  |
| noobaa_nsfs_op_filewrite_count                       | Number of filewrite operations                      | operations    |
| noobaa_nsfs_op_filewrite_error_count                 | Number of errors in filewrite operations            | errors        |
| noobaa_nsfs_op_filewritev_min_time_milisec           | Minimum time to vectored-write to an open file      | milliseconds  |
| noobaa_nsfs_op_filewritev_max_time_milisec           | Maximum time to vectored-write to an open file      | milliseconds  |
| noobaa_nsfs_op_filewritev_avg_time_milisec           | Average time to vectored-write to an open file      | milliseconds  |
| noobaa_nsfs_op_filewritev_count                      | Number of filewritev operations                     | operations    |
| noobaa_nsfs_op_filewritev_error_count                | Number of errors in filewritev operations           | errors        |
| noobaa_nsfs_op_filereplacexattr_min_time_milisec     | Minimum time to replace file extended attributes    | milliseconds  |
| noobaa_nsfs_op_filereplacexattr_max_time_milisec     | Maximum time to replace file extended attributes    | milliseconds  |
| noobaa_nsfs_op_filereplacexattr_avg_time_milisec     | Average time to replace file extended attributes    | milliseconds  |
| noobaa_nsfs_op_filereplacexattr_count                | Number of filereplacexattr operations               | operations    |
| noobaa_nsfs_op_filereplacexattr_error_count          | Number of errors in filereplacexattr operations     | errors        |
| noobaa_nsfs_op_linkfileat_min_time_milisec           | Minimum time to create a hard link from an open file | milliseconds |
| noobaa_nsfs_op_linkfileat_max_time_milisec           | Maximum time to create a hard link from an open file | milliseconds |
| noobaa_nsfs_op_linkfileat_avg_time_milisec           | Average time to create a hard link from an open file | milliseconds |
| noobaa_nsfs_op_linkfileat_count                      | Number of linkfileat operations                     | operations    |
| noobaa_nsfs_op_linkfileat_error_count                | Number of errors in linkfileat operations           | errors        |
| noobaa_nsfs_op_filegetxattr_min_time_milisec         | Minimum time to get file extended attributes        | milliseconds  |
| noobaa_nsfs_op_filegetxattr_max_time_milisec         | Maximum time to get file extended attributes        | milliseconds  |
| noobaa_nsfs_op_filegetxattr_avg_time_milisec         | Average time to get file extended attributes        | milliseconds  |
| noobaa_nsfs_op_filegetxattr_count                    | Number of filegetxattr operations                   | operations    |
| noobaa_nsfs_op_filegetxattr_error_count              | Number of errors in filegetxattr operations         | errors        |
| noobaa_nsfs_op_filestat_min_time_milisec             | Minimum time to stat an open file                   | milliseconds  |
| noobaa_nsfs_op_filestat_max_time_milisec             | Maximum time to stat an open file                   | milliseconds  |
| noobaa_nsfs_op_filestat_avg_time_milisec             | Average time to stat an open file                   | milliseconds  |
| noobaa_nsfs_op_filestat_count                        | Number of filestat operations                       | operations    |
| noobaa_nsfs_op_filestat_error_count                  | Number of errors in filestat operations             | errors        |
| noobaa_nsfs_op_filefsync_min_time_milisec            | Minimum time to fsync an open file                  | milliseconds  |
| noobaa_nsfs_op_filefsync_max_time_milisec            | Maximum time to fsync an open file                  | milliseconds  |
| noobaa_nsfs_op_filefsync_avg_time_milisec            | Average time to fsync an open file                  | milliseconds  |
| noobaa_nsfs_op_filefsync_count                       | Number of filefsync operations                      | operations    |
| noobaa_nsfs_op_filefsync_error_count                 | Number of errors in filefsync operations            | errors        |
| noobaa_nsfs_op_realpath_min_time_milisec             | Minimum time to resolve a path                      | milliseconds  |
| noobaa_nsfs_op_realpath_max_time_milisec             | Maximum time to resolve a path                      | milliseconds  |
| noobaa_nsfs_op_realpath_avg_time_milisec             | Average time to resolve a path                      | milliseconds  |
| noobaa_nsfs_op_realpath_count                        | Number of realpath operations                       | operations    |
| noobaa_nsfs_op_realpath_error_count                  | Number of errors in realpath operations             | errors        |
| noobaa_nsfs_op_getsinglexattr_min_time_milisec       | Minimum time to get a single extended attribute     | milliseconds  |
| noobaa_nsfs_op_getsinglexattr_max_time_milisec       | Maximum time to get a single extended attribute     | milliseconds  |
| noobaa_nsfs_op_getsinglexattr_avg_time_milisec       | Average time to get a single extended attribute     | milliseconds  |
| noobaa_nsfs_op_getsinglexattr_count                  | Number of getsinglexattr operations                 | operations    |
| noobaa_nsfs_op_getsinglexattr_error_count            | Number of errors in getsinglexattr operations       | errors        |
| noobaa_nsfs_op_diropen_min_time_milisec              | Minimum time to open a directory                    | milliseconds  |
| noobaa_nsfs_op_diropen_max_time_milisec              | Maximum time to open a directory                    | milliseconds  |
| noobaa_nsfs_op_diropen_avg_time_milisec              | Average time to open a directory                    | milliseconds  |
| noobaa_nsfs_op_diropen_count                         | Number of diropen operations                        | operations    |
| noobaa_nsfs_op_diropen_error_count                   | Number of errors in diropen operations              | errors        |
| noobaa_nsfs_op_dirclose_min_time_milisec             | Minimum time to close a directory                   | milliseconds  |
| noobaa_nsfs_op_dirclose_max_time_milisec             | Maximum time to close a directory                   | milliseconds  |
| noobaa_nsfs_op_dirclose_avg_time_milisec             | Average time to close a directory                   | milliseconds  |
| noobaa_nsfs_op_dirclose_count                        | Number of dirclose operations                       | operations    |
| noobaa_nsfs_op_dirclose_error_count                  | Number of errors in dirclose operations             | errors        |
| noobaa_nsfs_op_dirreadentry_min_time_milisec         | Minimum time to read a directory entry              | milliseconds  |
| noobaa_nsfs_op_dirreadentry_max_time_milisec         | Maximum time to read a directory entry              | milliseconds  |
| noobaa_nsfs_op_dirreadentry_avg_time_milisec         | Average time to read a directory entry              | milliseconds  |
| noobaa_nsfs_op_dirreadentry_count                    | Number of dirreadentry operations                   | operations    |
| noobaa_nsfs_op_dirreadentry_error_count              | Number of errors in dirreadentry operations         | errors        |
| noobaa_nsfs_op_safelink_min_time_milisec             | Minimum time to create a safe hard link             | milliseconds  |
| noobaa_nsfs_op_safelink_max_time_milisec             | Maximum time to create a safe hard link             | milliseconds  |
| noobaa_nsfs_op_safelink_avg_time_milisec             | Average time to create a safe hard link             | milliseconds  |
| noobaa_nsfs_op_safelink_count                        | Number of safelink operations                       | operations    |
| noobaa_nsfs_op_safelink_error_count                  | Number of errors in safelink operations             | errors        |
| noobaa_nsfs_op_safeunlink_min_time_milisec           | Minimum time to safely unlink a file                | milliseconds  |
| noobaa_nsfs_op_safeunlink_max_time_milisec           | Maximum time to safely unlink a file                | milliseconds  |
| noobaa_nsfs_op_safeunlink_avg_time_milisec           | Average time to safely unlink a file                | milliseconds  |
| noobaa_nsfs_op_safeunlink_count                      | Number of safeunlink operations                     | operations    |
| noobaa_nsfs_op_safeunlink_error_count                | Number of errors in safeunlink operations           | errors        |
...
> noobaa-cli diagnose metrics
{
    ...
    "reply": {
        ...
        "fs_worker_stats_counters": {
            "noobaa_nsfs_op_readfile_min_time_milisec": 66,
            "noobaa_nsfs_op_readfile_max_time_milisec": 84,
            "noobaa_nsfs_op_readfile_avg_time_milisec": 72,
            "noobaa_nsfs_op_readfile_count": 3,
            "noobaa_nsfs_op_readfile_error_count": 0,
            "noobaa_nsfs_op_stat_min_time_milisec": 29,
            "noobaa_nsfs_op_stat_max_time_milisec": 431,
            "noobaa_nsfs_op_stat_avg_time_milisec": 93,
            "noobaa_nsfs_op_stat_count": 16,
            "noobaa_nsfs_op_stat_error_count": 0,
            "noobaa_nsfs_op_realpath_min_time_milisec": 14,
            "noobaa_nsfs_op_realpath_max_time_milisec": 29,
            "noobaa_nsfs_op_realpath_avg_time_milisec": 21,
            "noobaa_nsfs_op_realpath_count": 4,
            "noobaa_nsfs_op_realpath_error_count": 2
        }
    }
}
```
