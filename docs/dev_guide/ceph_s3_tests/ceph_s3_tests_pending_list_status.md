...
| test_bucket_list_return_data_versioning             | Faulty Test        | [738](https://github.com/ceph/s3-tests/issues/738)                | Remove from `nsfs_s3_tests_black_list.txt` after the issue is resolved |