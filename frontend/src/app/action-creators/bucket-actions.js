...
export function completeUpdateBucketSpillover(bucket, resource) {
    return {
...
export function failUpdateBucketSpillover(bucket, resource, error) {
    return {
        type: FAIL_UPDATE_BUCKET_SPILLOVER,
        payload: { bucket, resource, error }
    };
}
