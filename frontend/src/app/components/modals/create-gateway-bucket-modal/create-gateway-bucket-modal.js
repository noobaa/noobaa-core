...
import template from './create-gateway-bucket-modal.html';
...
import { closeModal, createGatewayBucket } from 'action-creators';
import { inputThrottle } from 'config';

const formName = 'createGatewayBucket';
...
class CreateGatewayBucketModalViewModel extends Observer {
    constructor() {
        super();
    ...
    onState([ form, buckets, gatewayBuckets, resources ]) {
    ...
    onSubmit(values) {
        ...
        action$.onNext(createGatewayBucket(bucketName, readPolicy, writePolicy));
...
export default {
    viewModel: CreateGatewayBucketModalViewModel,
    template: template
};
