...
export const pool               = `${root}/systems/:system/resources/storage/pools/:pool/:tab?`;
export const cloudResource      = `${root}/systems/:system/resources/storage/cloud/:resource/:tab?`;
export const host               = `${root}/systems/:system/resources/storage/pools/:pool/nodes/:host/:tab?`;
