...
// Agent is an internal class of CreateAgent so we can set different names to dbg logger.
// this means we create a differnet class for each agent (differed by the dbg instance only)

function CreateAgent(agent_params) {
    const dbg = new DebugLogger(__filename);
    dbg.set_logger_name('Agent.' + agent_params.node_name);
