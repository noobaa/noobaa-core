...
async function main(argv = minimist(process.argv.slice(2))) {
    try {
        ...
        if (!endpoint) return print_usage();
        ...
        object_sdk._get_bucket_namespace = async name => ns_cache;
        ...
        console.log(`nscache: listening on http://localhost:${port}`);
