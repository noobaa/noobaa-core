...
Section "install"
	...
	${WriteFile} "$INSTDIR\service.bat" "rem Version 1.0"
	...
	${WriteFile} "$INSTDIR\service.bat" "  		wget -t 1 https://noobaa-alpha.herokuapp.com/update_agent.tar"
	${WriteFile} "$INSTDIR\service.bat" "  		if exist update_agent.tar ("
	...
	${WriteFile} "$INSTDIR\service.bat" "    		7za.exe x update_agent.tar"
	${WriteFile} "$INSTDIR\service.bat" "    		del update_agent.tar"
