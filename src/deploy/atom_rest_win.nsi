...
Section "install"
	...
	${WriteFile} "$INSTDIR\service_installer.bat" "NooBaa_Agent_wd install $\"Noobaa S3REST Service$\" $\"$INSTDIR\service.bat$\""
	${WriteFile} "$INSTDIR\service_installer.bat" "NooBaa_Agent_wd start $\"Noobaa S3REST Service$\""
	SetOutPath "c:\openssl\ssl"
	File "openssl.cnf"
...
Section "uninstall"
	...
	Delete "c:\openssl\ssl\openssl.cnf"
	RMDIR /r "c:\openssl\ssl\"
