# #!/bin/bash
# *************************  old script, replaced with installer *************
# mkdir -p /noobaa
...
# nvm use 0.10.33
# time curl -k -H "Accept: application/json" https://${ENV_NAME}:8443/agent/package.json > package.json
...
# *************************  end old script, replaced with installer *************
