 ...
 */
async function list_server_certificates(req, res) {
    ...
    dbg.log1('IAM LIST SERVER CERTIFICATES (returns empty list on every request)', params);
...
module.exports = {
    handler: list_server_certificates,
    body: {
