...
// for faster code see gf_mult_with_poly that does modulo with single xor
...
// it expects a and b to have a degree less than w.
...
function gf_mult_with_poly(w, p, a, b) {
    ...
    while (a && b) {
        ...
        a >>>= 1;
        b <<= 1;
        // set b modulo p, this avoids overflow from 32 bit
		b_mod = b ^ p;
		if (b_mod < b) {
			b = b_mod;
		}
