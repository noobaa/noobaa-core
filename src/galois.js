...
// for faster code see gf_mult_with_modulo that does modulo with single xor
...
// expects: deg(p) = w and deg(a),deg(b) < w.
function gf_mult_with_modulo(w, p, a, b) {
    var result = 0;
	var b_mod;
...
function test_mult_func(w, mult_func) {
    ...
    console.log('performance:', (count / ((end_time - start_time) / 1000)).toFixed(0),
        'mult/sec');
	console.log('coverage:', (x*100/max).toFixed(2), '%');
}

function gf_test_mult_with_poly(w) {
    console.log(' ');
    console.log('w', '=', w);
    console.log('gf_mult_with_modulo');
    test_mult_func(w, gf_mult_with_modulo.bind(null, w, gf_primitive_poly[w]));
    console.log('done');
}
...
function gf_test_mult_with_generator(w) {
    ...
    var generator = gf_init_generator(gf_primitive_poly[w]);
    console.log('gf_mult_with_generator');
...
var galois = {
    ...
    gf_mult_with_modulo: gf_mult_with_modulo,
