 ...
 * @param {string} name
 */
async function get_bucket_owner_account(config_root_backend, dir_path, name, is_symlink) {
    ...
    try {
        ...
        if (err.code === 'ENOENT') {
            ...
            throw_cli_error(ManageCLIError.BucketSetForbiddenNoBucketOwner, detail_msg, {bucket_owner: name});
        }
        throw err;
    }
}
