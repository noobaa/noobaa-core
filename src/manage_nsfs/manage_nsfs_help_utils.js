...
--force_md5_etag <true | false>                       (optional)        Update the account to force md5 etag calculation (unset with '')
`;
...
--force_md5_etag <true | false>                       (optional)        Update the bucket to force md5 etag calculation (unset with '')
`;
