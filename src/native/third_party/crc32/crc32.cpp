...
inline uint32_t crc32_4bytes_le(const void* data, size_t length, uint32_t previousCrc32 = 0)
{
    uint32_t  crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
    ...
    return crc32_1byte(current, length, ~crc);
}

inline uint32_t crc32_4bytes_be(const void* data, size_t length, uint32_t previousCrc32 = 0)
{
  uint32_t  crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t* current = (const uint32_t*) data;
  // process four bytes at once (Slicing-by-4)
...
{
    if (IS_BIG_ENDIAN) {
        return crc32_4bytes_be(data, length, previousCrc32);
    } else {
        return crc32_4bytes_le(data, length, previousCrc32);
    }
}


/// compute CRC32 (Slicing-by-8 algorithm)
uint32_t crc32_8bytes_le(const void* data, size_t length, uint32_t previousCrc32 = 0)
{
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t* current = (const uint32_t*) data;
...
/// compute CRC32 (Slicing-by-8 algorithm)
uint32_t crc32_8bytes_be(const void* data, size_t length, uint32_t previousCrc32 = 0)
{
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t* current = (const uint32_t*) data;
  // process eight bytes at once (Slicing-by-8)
...
{
    if (IS_BIG_ENDIAN) {
        return crc32_8bytes_be(data, length, previousCrc32);
    } else {
        return crc32_8bytes_le(data, length, previousCrc32);
    }
}
...
uint32_t crc32_4x8bytes_le(const void* data, size_t length, uint32_t previousCrc32 = 0)
{
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t* current = (const uint32_t*) data;
...
/// compute CRC32 (Slicing-by-8 algorithm), unroll inner loop 4 times
uint32_t crc32_4x8bytes_be(const void* data, size_t length, uint32_t previousCrc32 = 0)
{
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t* current = (const uint32_t*) data;
...
{
    if (IS_BIG_ENDIAN) {
        return crc32_4x8bytes_be(data, length, previousCrc32);
    } else {
        return crc32_4x8bytes_le(data, length, previousCrc32);
    }
}


/// compute CRC32 (Slicing-by-16 algorithm)
uint32_t crc32_16bytes_le(const void* data, size_t length, uint32_t previousCrc32 = 0)
{
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t* current = (const uint32_t*) data;
...
/// compute CRC32 (Slicing-by-16 algorithm)
uint32_t crc32_16bytes_be(const void* data, size_t length, uint32_t previousCrc32 = 0)
{
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t* current = (const uint32_t*) data;
...
{
    if (IS_BIG_ENDIAN) {
        return crc32_16bytes_be(data, length, previousCrc32);
    } else {
        return crc32_16bytes_le(data, length, previousCrc32);
    }
}


/// compute CRC32 (Slicing-by-16 algorithm, prefetch upcoming data blocks)
uint32_t crc32_16bytes_prefetch_le(const void* data, size_t length, uint32_t previousCrc32 = 0, size_t prefetchAhead = 256)
{
...
/// compute CRC32 (Slicing-by-16 algorithm, prefetch upcoming data blocks)
uint32_t crc32_16bytes_prefetch_be(const void* data, size_t length, uint32_t previousCrc32 = 0, size_t prefetchAhead = 256)
{
  // CRC code is identical to crc32_16bytes (including unrolling), only added prefetching
  // 256 bytes look-ahead seems to be the sweet spot on Core i7 CPUs
...
{
    if (IS_BIG_ENDIAN) {
        return crc32_16bytes_prefetch_be(data, length, previousCrc32);
    } else {
        return crc32_16bytes_prefetch_le(data, length, previousCrc32);
    }
}
