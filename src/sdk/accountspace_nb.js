...
class AccountSpaceNB {
    ...
    async get_user(params, account_sdk) {
        return await account_sdk.rpc_client.account.get_user(params);
    }

    async update_user(params, account_sdk) {
        return await account_sdk.rpc_client.account.update_user(params);
        // TODO : Clean account cache
        // TODO : Send Event
    }

    async delete_user(params, account_sdk) {
        return await account_sdk.rpc_client.account.delete_user(params);
        // TODO : clean account cache

    }

    async list_users(params, account_sdk) {
        return await account_sdk.rpc_client.account.list_users(params);
    ...
    async get_access_key_last_used(params, account_sdk) {
        return await account_sdk.rpc_client.account.get_access_key_last_used(params);
    }

    async update_access_key(params, account_sdk) {
        return await account_sdk.rpc_client.account.update_access_key(params);
        // TODO : clean account cache
    }

    async delete_access_key(params, account_sdk) {
        return await account_sdk.rpc_client.account.delete_access_key(params);
        // TODO : clean account cache
    }
    ...
    async untag_user(params, account_sdk) {
        return await account_sdk.rpc_client.account.untag_user(params);
    }
    ...
    async get_user_policy(params, account_sdk) {
        return await account_sdk.rpc_client.account.get_user_policy(params);
    }

    async delete_user_policy(params, account_sdk) {
        return await account_sdk.rpc_client.account.delete_user_policy(params);
    }

    async list_user_policies(params, account_sdk) {
        return await account_sdk.rpc_client.account.list_user_policies(params);
    }
}
