...
/** validation function that is used as a callback from all the services:
 * S3 (object_sdk), IAM (account_sdk), STS (sts_sdk)
 * It is the validation_callback
 * @param {object} data
 * @param {object} params
 */
...
module.exports._validate_account = _validate_account;
