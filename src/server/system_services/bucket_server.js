...
async function list_vector_objs(req, unsorted_system_collection, get_info_func) {
...
async function list_vector_buckets(req) {
    ...
    return await list_vector_objs(req, system_store.data.vector_buckets, get_vector_bucket_info);
}
...
async function list_vector_indices(req) {
    ...
    const vector_bucket = find_vector_bucket(req, req.rpc_params.vector_bucket_name);
    const res = await list_vector_objs(req, vector_bucket.vector_indices_by_name, get_vector_index_info);
    return res;
}
