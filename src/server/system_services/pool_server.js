...
/**
 * Replaces old_pool with new_pool in all tier mirrors and account defaults.
 * enable_migration=true adds new_pool as a mirror (for mirror_writer replication);
 * enable_migration=false (default) swaps in-place and resets placement to SPREAD.
 * Does not update BucketClass CRs — those must be patched separately by the user.
 */
