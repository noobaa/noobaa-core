...
require('../../unit_tests/api/test_namespace_fs');
require('../../unit_tests/api/test_ns_list_objects');
require('../../unit_tests/api/test_namespace_fs_mpu');
...
require('../../unit_tests/api/test_nsfs_versioning');
...
require('../../integration_tests/internal/test_public_access_block');
require('../../integration_tests/api/s3/test_nc_lifecycle_expiration');

// running with iam port
require('../../integration_tests/api/test_nc_iam_basic_integration.js'); // please notice that we use a different setup
