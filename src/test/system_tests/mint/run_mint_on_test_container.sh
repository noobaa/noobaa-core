...
# ROMY todo check that
cat >>config-local.js <<EOF
config.NSFS_CLACULATE_MD5 = true;
EOF
...
# ====================================================================================
# ROMY TODO: check on containerized deployment what else is supported
# currently the Non containerized supported mint test frameworks are:
# 1. aws-sdk-java
# 2. minio-go
# 3. s3cmd
