...
echo "NMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMNMN"
# Run the tests
node ./src/test/system_tests/test_bucket_access.js --mgmt_ip ${NOOBAA_MGMT_SERVICE_HOST} --mgmt_port ${PORT} --mgmt_port_https ${SSL_PORT} --s3_ip ${S3_SERVICE_HOST} --s3_port ${ENDPOINT_PORT} --s3_port_https ${ENDPOINT_SSL_PORT}
#node ./src/test/system_tests/test_bucket_placement.js
