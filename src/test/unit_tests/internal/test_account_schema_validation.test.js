...
describe('account_schema validation', () => {
    ...
    describe('account with all needed properties', () => {
        ...
        test('ACCOUNT without identity_type', () => {
            const account = { ...ACCOUNT };
            delete account.identity_type;
            expect(validate_account(account)).toBe(false);
        });
        ...
        test('ROLE identity with has_login', () => {
            expect(validate_account({ ...ROLE, has_login: false })).toBe(true);
        });
    ...
    describe('account without required properties', () => {
        ...
        test('ACCOUNT without identity_type after partial update merge', () => {
            const account = { ...ACCOUNT };
            delete account.identity_type;
            expect(validate_account({ ...account, allow_bucket_creation: true })).toBe(false);
        });
