...
function make_dummy_object_sdk() {
    return {
        requesting_account: {
            // Align with account_user2 so IAM users owned by that root resolve correctly
...
// account_user2 is the root account of account_iam_user1
const account_iam_user1 = {
    _id: '65a8edc9bc5d5bbf9db71b94',
    name: 'iam_user_1',
    email: 'iam_user_1@noobaa.io',
    owner: account_user2._id,
...
// account_user2 is the root account of account_iam_user2
