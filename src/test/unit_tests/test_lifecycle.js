...
mocha.describe('lifecycle', function() {
    ...
    mocha.describe('bucket-lifecycle-version', function() {
        ...
        mocha.it('lifecyle - version object expired', async function() {
            const age = 30;
        ...
        mocha.it('lifecyle - version object not expired', async function() {
            const age = 5;
            const version_count = 10;
        ...
        mocha.it('lifecyle - version not expiration', async function() {
            const days = 30;
            const version_count = 10;
        ...
        mocha.it('lifecyle - version expiration - only NewerNoncurrentVersions exceeded', async function() {
            const days = 35;
            const version_count = 10;
        ...
        mocha.it('lifecyle - version expiration - only NoncurrentDays exceeded', async function() {
            const days = 45;
            const version_count = 10;
        ...
        mocha.it('lifecyle - version expiration - both NoncurrentDays and NewerNoncurrentVersions exceeded', async function() {
            const days = 30;
            const version_count = 10;
            const newnon_current_version = 1;
            const noncurrent_days = 15;
        ...
        mocha.it('lifecyle - version not expiration - delete marker true', async function() {
            const days = 30;
            const version_count = 10;
            const noncurrent_days = 15;
        ...
        mocha.it('lifecyle - version expiration all - delete marker true', async function() {
            const days = 30;
            const version_count = 10;
            const noncurrent_days = 15;
